...
from dreamkiller.modules import ALL_MODULES
from dreamkiller.modules.disable import DisableAbleCommandHandler
from dreamkiller.modules.helper_funcs.chat_status import is_user_admin
from dreamkiller.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="👑 Owner", url=f"https://t.me/FULLY_CRUAL_MIND"),
        InlineKeyboardButton(text="📶 Network", url=f"https://t.me/KK_LINKS"),
    ],
    [
...
HELP_STRINGS = """
Hello There! My name is **《ᴤᴛᴲᴎᴣᴌᴇ᚛〄᚜ᴹᴀᴙᴉᴀ》**
"""

HELP_MSG = "Click the button below to get help manu in your pm."
DONATE_STRING = """*don't need donate I'm free for everyone add your group's in @dreamkillerRobot this is my donate🙂*"""
HELP_IMG = "http://telegra.ph/file/2eccfe82927c52261ff3c.jpg"
GROUPSTART_IMG = "http://telegra.ph/file/f5491e102e7563816aedf.mp4"

VEGETA_IMG = (
    "http://telegra.ph/file/0ccaa6258de1ed642d581.jpg",
    "http://telegra.ph/file/dd8ce02588ce9d9517d02.jpg",
)
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("dreamkiller.modules." + module_name)
        ...
        update.effective_message.reply_animation(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="📶 Network", url=f"https://t.me/KK_LINKS"
                        ),
                        InlineKeyboardButton(
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(
                f"@{SUPPORT_CHAT}",
                "[YOUR YOR IS BACK](http://telegra.ph/file/f5491e102e7563816aedf.mp4)",
                parse_mode=ParseMode.MARKDOWN,
            )
        except Unauthorized:
            LOGGER.warning(
